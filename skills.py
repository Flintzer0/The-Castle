...
class cleave(Skill):
    def __init__(self):
        super().__init__(name="Cleave", cost=5, damage=5, damage_type="", bonus_stat="STR",
...
class sneak_attack(Skill):
    def __init__(self):
        super().__init__(name="Sneak Attack", cost=5, damage=5, damage_type="", bonus_stat="SKL",
...
class precision_strike(Skill):
    def __init__(self):
        super().__init__(name="Precision Strike", cost=5, damage=5, damage_type="", bonus_stat="SKL",
...
class double_strike(Skill):
    def __init__(self):
        super().__init__(name="Double Strike", cost=5, damage=5, damage_type="", bonus_stat="SPD",
