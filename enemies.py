class Enemy:
    def __init__(self, name, hp, damage, DEF, RES, SPD, SKL, LUCK, description):
        self.name = name
        self.hp = hp
        self.damage = damage
        self.DEF = DEF
...
class giant_spider(Enemy):
    def __init__(self):
        super().__init__(name="Giant Spider", hp=10, damage=2, DEF=0, RES=1, SPD=3, SKL=2, LUCK=1,
...
class goblin(Enemy):
    def __init__(self):
        super().__init__(name="Goblin", hp=5, damage=1, DEF=1, RES=0, SPD=2, SKL=1, LUCK=0,
...
class skeleton(Enemy):
    def __init__(self):
        super().__init__(name="Skeleton", hp=7, damage=3, DEF=2, RES=-1, SPD=1, SKL=0, LUCK=0,
