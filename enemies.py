...
class giant_spider(Enemy):
    def __init__(self):
        super().__init__(name="Giant Spider", hp=10, mhp=10, damage=2, weak=None, DEF=0, RES=1, SPD=3, SKL=2, LUCK=1, EXP=13, gold=10,
...
class goblin(Enemy):
    def __init__(self):
        super().__init__(name="Goblin", hp=5, mhp=5, damage=1, weak="Cold", DEF=1, RES=0, SPD=2, SKL=1, LUCK=0, EXP=10, gold=16,
...
class large_rat(Enemy):
    def __init__(self):
        super().__init__(name="Large Rat", hp=15, mhp=10, damage=3, weak="Fire", DEF=1, RES=1, SPD=1, SKL=0, LUCK=0, EXP=15, gold=15,
